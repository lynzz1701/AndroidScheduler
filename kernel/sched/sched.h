...
extern void free_wrr_sched_group(struct task_group *tg);   //2018.06.14
...
struct wrr_rq {
	...
	//unsigned long total_weight;  //2018.06.11
...
#endif
#ifdef CONFIG_WRR_GROUP_SCHED
	struct list_head leaf_wrr_rq_list;  //2018.06.11
#endif
	/*
...
extern const struct sched_class wrr_sched_class;  // 2018.06.14
...
extern void init_sched_wrr_class(void);  // 2018.06.14
...
#else
static inline void sched_rt_avg_update(struct rq *rq, u64 rt_delta) { }
static inline void sched_wrr_avg_update(struct rq *rq, u64 rt_delta) { }
...
extern void print_wrr_stats(struct seq_file *m, int cpu); //2018.06.14

extern void init_cfs_rq(struct cfs_rq *cfs_rq);
extern void init_rt_rq(struct rt_rq *rt_rq, struct rq *rq);
extern void init_wrr_rq(struct wrr_rq *wrr_rq, struct rq *rq);  //2018.06.14
